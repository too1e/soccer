...
model_saving <- lm(exSaves ~ MP + `90s` + GA + GA90 + SoTA + 
...
ggplot(GK_filtered, aes(x = Player, y = exSaves)) +
  geom_bar(stat = "identity", fill = "navy") +
  theme_minimal() +
  labs(title = "Expected Saves by Goalkeeper (English Premier League)", x = "Player", y = "Expected Saves") +
...
ggplot(tmshots_filtered, aes(x = Squad, y = exsvs)) +
  geom_bar(stat = "identity", fill = "navy") +
  theme_minimal() +
